...
class QuizTakerDisplay extends JFrame {
	...
	public static void main(String[] args) {
		...
		window = new QuizTakerDisplay();
	}

	// Constructor
	private QuizTakerDisplay() {
	...
	private class GameAreaPanel extends JPanel {
		...
		GameAreaPanel(){
			...
			questions = new SimpleLinkedList<String>();
		...
		public void paintComponent(Graphics g) {
			...
			answer1.setText(Double.toString(wrongAnswer[questionNum][0]));
			answer2.setText(Double.toString(wrongAnswer[questionNum][1]));
			answer3.setText(Double.toString(wrongAnswer[questionNum][2]));
			answer4.setText(Double.toString(wrongAnswer[questionNum][3]));
...
//			System.out.println("X:" + e.getX() + " y:" + e.getY());
	...
	private class Answer1Listener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if(wrongAnswer[questionNum][0] == answers.get(questionNum)) {
	...
	private class Answer2Listener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if(wrongAnswer[questionNum][1] == answers.get(questionNum)) {
				System.out.println("yay");
			}else {
	...
	private class Answer3Listener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if(wrongAnswer[questionNum][2] == answers.get(questionNum)) {
				System.out.println("yay");
			}else {
